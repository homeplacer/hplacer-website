    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <input id="sr-phone" name="phone" type="tel" inputMode="tel" pattern="[0-9()+.\s-]{7,}" title="Please enter a valid phone number." required autoComplete="tel" className={fieldClass} />
        </div>
      </div>
      <div>
