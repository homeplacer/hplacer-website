...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: "Both ways. Most buyers do a complete land-home package, but if you already have land we'll sell and set the home on your lot. Either way, we handle the setup.",
  },
  {
    q: "How much does a new manufactured home on land cost?",
    a: "Packages start in the low $200s and vary by model, size, and lot. Because every site is different, we give you an exact all-in number for the home and land together — just ask.",
  },
  {
    q: "Is there an HOA?",
  ...
  },
  {
    ...
    a: "We hand-pick floor plans from Clayton, Cavco, and Champion — three of the most trusted manufactured-home builders in the country — and place them on land across Horry County.",
  },
  {
  ...
  },
  {
    ...
    a: "Across the Grand Strand and Horry County — Myrtle Beach, Conway, Loris, Longs, and Aynor — on scattered lots, so your home isn't confined to one subdivision.",
  },
  {
